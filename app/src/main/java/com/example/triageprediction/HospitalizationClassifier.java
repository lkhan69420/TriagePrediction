...
public class HospitalizationClassifier {
    ...
    public HospitalizationClassifier(String hidden, String output, int[] layers, double[][][] weights, double[][] bias) {
    ...
    public HospitalizationClassifier(String hidden, String output, int neurons, double[][][] weights, double[][] bias) {
